public class Box8Runner {
    public static void main(String []args){
		Box8 item=new Box8();
		double price=item.getPriceByFoodName("half boil");
        ...
        Box8 item1=new Box8();
		double price1=item1.getPriceByFoodName("pepper dry");
        ...
        Box8 item2=new Box8();
        double price2=item2.getPriceByFoodName("egg curry");
        ...
        Box8 item3=new Box8();
        double price3=item3.getPriceByFoodName("egg sambar");
        ...
        Box8 item4=new Box8();
        double price4=item4.getPriceByFoodName("egg rice");
